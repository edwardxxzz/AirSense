...
const styles = StyleSheet.create({
  ...
  inputGroup: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'white', borderWidth: 1, borderColor: '#E2E8F0', borderRadius: 12, paddingHorizontal: 12, height: 50, overflow: 'hidden' },
  separator: { width: 5 },
  input: { flex: 1, color: '#1E293B', fontSize: 15, paddingHorizontal: 10, paddingVertical: 0, outlineColor: "transparent", outlineWidth: 0 },
