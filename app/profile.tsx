...
const styles = StyleSheet.create({
  ...
  inputContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#FFF', borderWidth: 1, borderColor: '#E2E8F0', borderRadius: 12, paddingHorizontal: 12, height: 46, gap: 10, overflow: 'hidden' },
  textInput: { flex: 1, fontSize: 15, color: '#1E293B', paddingVertical: 0, outlineWidth: 0, outlineColor: "transparent" },
